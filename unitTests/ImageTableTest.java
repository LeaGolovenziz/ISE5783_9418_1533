    ...
    public void ourPicture(){
        ...
        scene.geometries.add(
                new Sphere(new Point(-95,50,-300),10).setEmission(new Color(24,95,12))
                        .setMaterial(new Material().setKD(0.5).setKS(0.8).setKT(0.1).setShininesR(0.9).setNShininess(20)),
                ...
                new Polygon(A,B,C,D)
                        ...
                        .setMaterial(new Material().setKD(0.5).setKS(0.1).setKT(0).setShininesR(0).setNShininess(20)),
                new Polygon(E,F,G,H)
                        .setEmission(new Color(WHITE))
                        .setMaterial(new Material().setKD(0.5).setKS(0.1).setKT(0).setShininesR(0).setNShininess(20)),
                new Polygon(A,D,H,E)
                ...
                new Triangle(new Point(-105,200,700),new Point(-105,5,700),new Point(-105,5,-2500))
                        .setEmission(new Color(102,0,153))
                        .setMaterial(new Material().setKD(0.5).setKS(0.5).setKT(0.1).setShininesR(0.1).setNShininess(20)),
                new Plane(new Point(-1000,28,0),new Point(90,5,0),new Point(-105,33,-2034))
                        .setEmission(new Color(GRAY))
                        .setMaterial(new Material().setKD(0.5).setKS(0.5).setShininesR(0.25))
        );
