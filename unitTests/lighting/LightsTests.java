...
public class LightsTests {
   ...
   private Point trPL = new Point(30, 10, -100); // Triangles multi test Position of Light
   private Point spPL = new Point(-50, -50, 25); // Sphere multi test Position of Light
   private Color trCL = new Color(800, 500, 250); // Triangles multi test Color of Light
   private Color spCL = new Color(800, 500, 0); // Sphere multi test Color of Light
   private Vector trDL = new Vector(-2, -2, -2); // Triangles multi test Direction of Light
   ...
   public void sphereMultiLights() {
      scene1.geometries.add(sphere);
      scene1.lights.add(new DirectionalLight(spCL, new Vector(-1, -0.8, -0.5)));
